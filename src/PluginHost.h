...
class PluginHost : public QObject, public BaseHost
{
    Q_OBJECT
    ...
    Q_PROPERTY(bool isNativeGuiOpen READ isNativeGuiOpen WRITE setIsNativeGuiOpen NOTIFY isNativeGuiOpenChanged)
    QML_ELEMENT
  ...
  public:
    ...
    [[nodiscard]] bool isNativeGuiOpen() const { return m_isNativeGuiOpen; }
    void setIsNativeGuiOpen(bool value);
